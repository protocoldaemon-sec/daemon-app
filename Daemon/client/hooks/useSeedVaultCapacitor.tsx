...
import { seedVault, SeedVaultAPI, SeedVaultSeed, SeedVaultAccount, SeedVaultAuthResult } from '@/utils/seedVaultCapacitor';
import { PublicKey } from '@solana/web3.js';
import bs58 from 'bs58';

/**
 * React hook for Seed Vault wallet functionality using Capacitor
 * Compatible with web/React apps wrapped in Capacitor
 */
export function useSeedVaultCapacitor() {
